    ...
    <div class="relative h-screen w-full">
      ...
      <div class="relative flex flex-col justify-center items-center h-full text-white px-6">
        <div class="text-center">
          <h1 class="text-5xl font-bold">Transfer Desde/Hasta el aeropuerto de Málaga</h1>
          <p class="mt-4 text-lg">Último modelo de Vehículos de alta gama - ¡Reserva ahora!</p>
          ...
          <form @submit.prevent="reservar" class="bg-white p-4 rounded-lg shadow-lg mt-6 max-w-4xl w-full mx-auto text-black">
            <div class="grid grid-cols-5 gap-4 items-center">
              ...
              <button type="submit" class="bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition w-full">
                Reservar
              </button>
            </div>
          </form>
      ...
      <transition name="slide">
        <div v-if="mostrarPanel" class="fixed top-80 right-0 h-[calc(100%-rem)] w-64 bg-white shadow-lg p-4 flex flex-col items-center z-50">
